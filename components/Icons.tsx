...
export function BasketballIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path d="M5.5 5.5c2 2 4 3 6.5 3s4.5-1 6.5-3" />
      <path d="M5.5 18.5c2-2 4-3 6.5-3s4.5 1 6.5 3" />
    </svg>
  );
}
...
export function VolleyballIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <circle cx="12" cy="12" r="9" />
      <path d="M12 3c0 5 2 8 6 10" />
      <path d="M6 19c2-4 6-5 10-3" />
      <path d="M3 10c4 1 6 4 6 8" />
    </svg>
  );
}
...
export function BracketIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h4v4H4zM4 14h4v4H4zM16 10h4v4h-4zM8 8h4M8 16h4M12 8v4h4M12 16v-4" />
    </svg>
  );
}
